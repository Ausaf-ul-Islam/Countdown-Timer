...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-purple-300 via-purple-500 to-purple-700 dark:bg-gradient-to-br dark:from-purple-800 dark:via-purple-900 dark:to-black">
      {/* Timer box container */}
      <div className="bg-white dark:bg-gray-800 shadow-xl rounded-3xl p-8 w-full max-w-lg border-[3px] border-purple-800 dark:border-purple-900">
        {/* Title of the countdown timer */}
        <h1 className="text-3xl font-extrabold mb-4 text-purple-800 dark:text-purple-400 text-center tracking-wider">
          Countdown Timer
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-full border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-200 focus:ring-purple-500 focus:border-purple-500"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-purple-800 dark:text-purple-400 border-purple-500 hover:bg-purple-200 dark:hover:bg-purple-600"
          >
            Set
          </Button>
        </div>
        {/* Display the formatted time left */}
        <div className="text-6xl font-extrabold text-purple-900 dark:text-purple-300 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
      ...
      <p className="m-5 font-extrabold">
        Built By With <span className="text-red-700">❤</span> Ausaf Ul Islam
      </p>
    </div>
  );
}
